...
const REGION_ROLES = ['지역장', '임원', '지역총무', '지역서기', '지역전도서기']
const TEAM_ROLES = ['팀장', '팀전도교관', '팀서기', '팀전도서기']
...
/**
 * 권한 헬퍼.
 *   isAdmin       — POSITION='관리자'/'임원' 또는 ADMIN_SABUNS allow-list (auth store)
 *   hasRegionRole — 지역 직책 (지역장/임원/총무/서기/전도서기)
 *   hasTeamRole   — 팀 직책 (팀장/팀전도교관/팀서기/팀전도서기) — 지역권한 자동 포함
